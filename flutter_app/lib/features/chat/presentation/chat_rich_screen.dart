...
class _ChatRichScreenState extends ConsumerState<ChatRichScreen> {
  ...
  IconData? _replyTypeIcon(MessageType type) => switch (type) {
        ...
        MessageType.callLog => LucideIcons.phone,
...
class _CallLogRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isMissed) {
      icon = isVideo ? LucideIcons.videoOff : LumioIcons.arrowDownLeft;
      iconColor = AppColors.danger;
    } else if (isDeclined) {
      icon = isVideo ? LucideIcons.videoOff : LumioIcons.phoneOff;
                  ...
                  children: [
                    ...
                    _ReactionPillButton(
                      ...
                      child: Container(
                        ...
                        child:
                            Icon(LucideIcons.plus, color: colors.fg2, size: 20),
                      ),
                    ),
                  ],
                ),
